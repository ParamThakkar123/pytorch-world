...
| Name | Source | Description |
|---|---|---|
| `DreamerOperator` | `torchwm.inference.operators` | Dreamer input preprocessing. |
| `JEPAOperator` | `torchwm.inference.operators` | JEPA image masking and patching. |
| `IrisOperator` | `torchwm.inference.operators` | IRIS sequence tokenization. |
| `PlaNetOperator` | `torchwm.inference.operators` | PlaNet action/state preprocessing. |
